...
local function CreateTabButton(parent, text, x, y, width, height)
    ...
    local btn = CreateFrame("Button", btnName, parent, "CharacterFrameTabButtonTemplate")
    btn:SetPoint("TOPLEFT", parent, "TOPLEFT", x, y)
    btn:SetText(text or "")
    if width then
        btn:SetWidth(width)
...
local function CreatePreviewPage(parent)
    ...
    CreateDivider(left, 14, -405, 220)
    CreateTitle(left, "Starter / Ender", 14, -428, 220)
    CreateLabel(left, "Start NPC", 14, -458, 80)
    preview.widgets.startNpcLabel = CreateMutedLabel(left, "", 100, -458, 140)
    CreateLabel(left, "End NPC", 14, -480, 80)
    preview.widgets.endNpcLabel = CreateMutedLabel(left, "", 100, -480, 140)
    ...
    CreateDivider(right, 14, -430, 220)
    preview.widgets.repText = CreateLabel(right, "", 14, -452, 220)
    preview.widgets.honorText = CreateLabel(right, "", 14, -478, 220)
...
local function CreateMainFrame()
    ...
    frame:SetBackdropColor(DARK_BG_R, DARK_BG_G, DARK_BG_B, 1)
    frame:SetBackdropBorderColor(1, 1, 1, 1)
    local horde = frame:CreateTexture(nil, "OVERLAY")
    horde:SetPoint("TOPLEFT", frame, "TOPLEFT", 18, -18)
    horde:SetWidth(40)
    horde:SetHeight(46)
    ...
    for i, item in ipairs(nav) do
        local btn = CreateTabButton(frame, item[1], 0, 0)
        btn:ClearAllPoints()
        if i == 1 then
            btn:SetPoint("TOPLEFT", frame, "TOPLEFT", 22, -64)
        else
            btn:SetPoint("TOPLEFT", prevTab, "TOPRIGHT", -16, 0)
        end
        btn:SetScript("OnClick", function()
    ...
    contentFrame:SetPoint("TOPLEFT", frame, "TOPLEFT", 22, -90)
    contentFrame:SetWidth(1106)
    contentFrame:SetHeight(540)
